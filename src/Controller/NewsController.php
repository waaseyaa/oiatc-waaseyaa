    ...
    private function potentiaPost(): array
    {
        return [
            ...
            'body' => '<p>Potentia Renewables has responded in writing to OIATC\'s five questions about the Massey Solar Project, on the record. Patrick Russell, a project manager at Potentia, sent the response on June 2, 2026. Here is what it says.</p>'
                ...
                . '<p>A few things were not addressed. Potentia did not detail the public and Indigenous consultation plan for the approval, or say whether pre-application discussions with the ministry have begun.</p>'
